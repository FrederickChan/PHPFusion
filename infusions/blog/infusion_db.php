...
if ( defined( 'BLOG_EXISTS' ) ) {
    ...
    function blog_user_action_hook( $action, $user_id ) {
        if ( $action == 'delete_user' ) {

            // Delete blog
            dbquery( "DELETE FROM " . DB_BLOG . " WHERE blog_name=:uid", [':uid' => $user_id] );

            // Delete blog submissions
     ...
     */
    fusion_add_hook( 'fusion_user_action', 'blog_user_action_hook', 10, [], 2 );
