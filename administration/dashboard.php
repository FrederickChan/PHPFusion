...
add_breadcrumb(['link' => ADMIN.'settings_main.php'.fusion_get_aidlink(), 'title' => 'Dashboard']);
...
//                        $_idata['admin_title'] = $locale[$_idata['admin_rights']] ?? $_idata['admin_title'];
//                    }
