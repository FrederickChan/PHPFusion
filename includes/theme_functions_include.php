 ...
 * @return string
 */
function tooltip($title, array $options = []) {
    $options += [
        'placement' => 'top', // left, right, bottom
    ];

    if (!defined('TOOLTIP_ENABLED')) {
        define('TOOLTIP_ENABLED', TRUE);
        add_to_jquery('
    ...
    return 'data-bs-toggle="tooltip" data-bs-placement="' . $options['placement'] . '" title="' . $title . '"';
}
