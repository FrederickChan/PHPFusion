...
require_once __DIR__ . '/format_include.php';
require_once __DIR__ . '/protocol_include.php';
require_once __DIR__ . '/users_include.php';
require_once __DIR__ . '/groups_include.php';
require_once __DIR__ . '/language_include.php';
