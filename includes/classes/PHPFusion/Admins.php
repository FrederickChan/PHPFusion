...
class Admins {
    ...
    private $custom_icons = [
        ...
        'IM' => 'photos', // Images
        'UL' => 'user_logs', // User Log
        'UF' => 'user_fields', // User Fields
        'UG' => 'usergroups', // User Groups
        'MI' => 'delivery', // Migration Tool
        'M' => 'users', //Members
        'B' => 'blacklist', //Blacklist
        'APWR' => 'admin_pass', //Admin Password Reset
        'AD' => 'admin', // Administrators
        'MAIL' => 'mail_unread', // Email
        'ROB' => 'robot', //Robots
        'TS' => 'theme', // Theme
        'SM' => 'smileys', // Smileys
        'SL' => 'sitelinks', // Sitelinks
        'PI' => 'phpinfo', // PHP Info
        'PL' => 'fad fa-anchor', // Permalinks
        'P' => 'panel', //Panels
        'I' => 'infusion', // Infusions
        'ERRO' => 'errors', // Error
        'DB' => 'db', // database
        'BB' => 'bbcode', // bbcode
        'SB' => 'banner', // shoutbox
        'LANG' => 'language', // Language Settings
        'S12' => 'security', // Security
        'S9' => 'user_settings', // User Management
        'S7' => 'mail-unread', // PM
        'S6' => 'misc', //Miscellaneous
        'S4' => "registration", // Registration
        'S3' => 'fad fa-cogs', // Theme Settings
        'S2' => 'timedate', // Time and Date
