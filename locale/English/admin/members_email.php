<?php
$locale['email_sys_notice'] = "This notification has been sent to the email address associated with your [SITENAME] account. This email message was auto-generated. Please do not respond. If you need any additional help, please visit the [SITENAME] Support.";
...
You can activate account with the following link:<br>[ACTIVATION_LINK]<br>Regards,<br>[SITEUSERNAME]";

$locale['email_2fa_name'] = "Two-Factor Authorization PIN";
...
$locale['email_auth_name'] = "Two-Factor Verification PIN";
$locale['email_auth_subject'] = "Your [SITENAME] account One Time Passcode";
$locale['email_auth_message'] = "It looks like you are trying to change your settings with [SITENAME].<br><br>
Here is the 2FA Pin code you need to update your account: [OTP]<br><br>
This email was sent because someone attempted to log into your [SITENAME] account. The login attempt included your correct username and password.<br><br>
If you are not trying to log in, we recommend that you reset your [SITENAME] password as the security of your [SITENAME] account may be compromised. The login pin contained in this email is required to access your account. Do not share the pin with anyone.<br><br>
...
If you change your mind, you can reactivate your account by logging in with your credentials before the deactivation period ends. To reactivate your account anytime before [DURATION], simply click the following link: [REACTIVATION_LINK]<br>Sincerely,<br>[SITEUSERNAME]";

$locale['email_user_close_name'] = "Account Closing Email";
$locale['email_user_close_subject'] = "Account closing at [SITENAME]";
$locale['email_user_close_message'] = "Hello [USER_NAME],<br>
We have received your request to close your account with us. We are sorry to see you go and we hope you enjoyed our service.<br>
Your account has been deactivated and you will no longer have access to your data, preferences and history.<br>
Thank you for choosing us and we wish you all the best.<br><br>
Regards,<br>[SITEUSERNAME]";
